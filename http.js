...
export const UNNECESSARY_ACCESS_TOKEN = ['/V/INDEX/GETSITEINFO', '/V/USER/USERLOGIN', '/V/USER/INITREGISTER', '/V/INDEX/QUERYBANNERLIST', '/V/SYS/NOTICE/QUERYHOMENOTICE', '/V/GAME/GETGAMELIST'];
...
function signQuery(params) {
    ...
    console.log('解密数据', md5(query.sign.siteId));
...
const appendAccessToken = (api, uri) => {
    ...
    tempApi = tempApi.toUpperCase();
    const necessary = UNNECESSARY_ACCESS_TOKEN.indexOf(tempApi) === -1;
        ...
        axios(config)
            ...
            .then(data => {
                if (SUCCESS_KEYS.indexOf(data.key) !== -1) {
                    ...
                    reject(Object.assign({}, data, { status: 401, text: '账户异常冻结' }));
                } else {
                    reject(data);
                }
            })
